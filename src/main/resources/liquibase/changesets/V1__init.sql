...
ALTER TABLE
    "client" ADD CONSTRAINT "client_id_foreign" FOREIGN KEY("id") REFERENCES "email"("id");
ALTER TABLE
    "phone_number" ADD CONSTRAINT "phone_number_client_id_foreign" FOREIGN KEY("client_id") REFERENCES "client"("id");
ALTER TABLE
